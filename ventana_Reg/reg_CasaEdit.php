    ...
    if(isset($_REQUEST['boton'])){
        if(!empty($_POST['edit'])){
            ...
            try{    
                ...
                $stmt = "INSERT INTO reg_editorial (nombre_Editorial) VALUES ('$edit')";
...
<html lang="en">
  <head>
    ...
    <title>Registro casa editorial</title>
            ...
            <div class="row align-items-stretch no-gutters contact-wrap">
                <div class="col-md-12">
                    <div class="form h-100">
                        <h3 _msthash="1213043" _msttexthash="115427">Registro de casa editorial</h3>
                        <form class="mb-5" method="post" id="formSoli" name="formNac" novalidate="novalidate">
                            <div class="row">
                                <div class="col-md-6 form-group mb-3">
                                    <label for="" class="col-form-label" _msthash="841113" _msttexthash="83291">Nombre de la editorial</label>
                                    <input type="text" class="form-control" name="edit" placeholder="Ingresa el nombre de la editorial" _mstplaceholder="113022">
                                </div>
                            <div class="row">
