    ...
    if(isset($_REQUEST['boton'])){
        if(!empty($_POST['pais'])){
            ...
            try{    
                ...
                $stmt = "INSERT INTO reg_nacionalidad (nacionalidad) VALUES ('$nacionalidad')";
            ...
            <div class="row align-items-stretch no-gutters contact-wrap">
                <div class="col-md-12">
                    <div class="form h-100">
                        <h3 _msthash="1213043" _msttexthash="115427">Registro de nacionalidad</h3>
                        <form class="mb-5" method="post" id="formSoli" name="formNac" novalidate="novalidate">
                            <div class="row">
                                <div class="col-md-6 form-group mb-3">
                                    <label for="" class="col-form-label" _msthash="841113" _msttexthash="83291">País de origen</label>
                                    <input type="text" class="form-control" name="pais" placeholder="Ingresa el país" _mstplaceholder="113022">
                                </div>
                            <div class="row">
