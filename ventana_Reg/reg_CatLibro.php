...
<html lang="en">
  <head>
    ...
    <title>Registro categorias de libro</title>
            ...
            <div class="row align-items-stretch no-gutters contact-wrap">
                <div class="col-md-12">
                    <div class="form h-100">
                        <h3 _msthash="1213043" _msttexthash="115427">Registro de categorias de libros</h3>
                        <form class="mb-5" method="post" id="formSoli" name="formNac" novalidate="novalidate">
                            <div class="row">
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="categ" placeholder="Ingresa la categoria" _mstplaceholder="113022">
                                </div>
                            <div class="row">
